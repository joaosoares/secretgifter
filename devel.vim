...
xnoremap <SNR>61_VisualNrrwBang :call nrrwrgn#VisualNrrwRgn(visualmode(),'!')
xnoremap <SNR>61_VisualNrrwRgn :call nrrwrgn#VisualNrrwRgn(visualmode(),'')
...
set mouse=a
set ruler
set runtimepath=~/.vim/janus/vim/core/before,~/.vim/janus/vim/core/janus,~/.vim/janus/vim/core/pathogen,~/.vim/janus/vim/colors/getafe,~/.vim/janus/vim/colors/github,~/.vim/janus/vim/colors/irblack,~/.vim/janus/vim/colors/janus-colors,~/.vim/janus/vim/colors/molokai,~/.vim/janus/vim/colors/pyte,~/.vim/janus/vim/colors/sampler-pack,~/.vim/janus/vim/colors/solarized,~/.vim/janus/vim/colors/vividchalk,~/.vim/janus/vim/langs/arduino,~/.vim/janus/vim/langs/clojure,~/.vim/janus/vim/langs/coffeescript,~/.vim/janus/vim/langs/csv,~/.vim/janus/vim/langs/cucumber,~/.vim/janus/vim/langs/erlang,~/.vim/janus/vim/langs/git,~/.vim/janus/vim/langs/haml,~/.vim/janus/vim/langs/handlebars,~/.vim/janus/vim/langs/haskell,~/.vim/janus/vim/langs/javascript,~/.vim/janus/vim/langs/less,~/.vim/janus/vim/langs/markdown,~/.vim/janus/vim/langs/minitest,~/.vim/janus/vim/langs/mustache,~/.vim/janus/vim/langs/nodejs,~/.vim/janus/vim/langs/puppet,~/.vim/janus/vim/langs/rails,~/.vim/janus/vim/langs/rspec,~/.vim/janus/vim/langs/ruby,~/.vim/janus/vim/langs/sca
set shiftwidth=2
set smartcase
set statusline=%f\ %m\ %rLine:%l/%L[%p%%]Col:%vBuf:#%n[%b][0x%B]
set tabstop=2
set wildignore=*.o,*.out,*.obj,.git,*.rbc,*.rbo,*.class,.svn,*.gem,*.zip,*.tar.gz,*.tar.bz2,*.rar,*.tar.xz,*/vendor/gems/*,*/vendor/cache/*,*/.bundle/*,*/.sass-cache/*,*.swp,*~,._*,*.pyc
set window=0
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/Projects/secretgifter
...
badd +0 app/views.py
badd +0 app/forms.py
badd +4 app/templates/register.html
badd +6 app/templates/login.html
badd +5 app/templates/pricing.html
badd +35 app/templates/layout.html
badd +0 app/static/css/style.css
badd +0 app/templates/noauth.html
badd +1 app/templates/index.html
badd +0 app/models.py
badd +0 Procfile
silent! argdel *
edit app/views.py
...
setlocal tabstop=4
setlocal tags=~/Projects/secretgifter/.git/python.tags,~/Projects/secretgifter/.git/tags,./tags,tags
...
silent! normal! zE
let s:l = 23 - ((19 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
normal! 019l
tabedit app/forms.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal tabstop=2
setlocal tags=~/Projects/secretgifter/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal tabstop=2
setlocal tags=~/Projects/secretgifter/.git/htmldjango.tags,~/Projects/secretgifter/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 43 - ((0 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
normal! 0
tabedit app/templates/layout.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal tabstop=2
setlocal tags=~/Projects/secretgifter/.git/html.tags,~/Projects/secretgifter/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((2 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
normal! 0
tabedit app/templates/noauth.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
5
normal! 047l
tabedit app/static/css/style.css
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal tabstop=2
setlocal tags=~/Projects/secretgifter/.git/css.tags,~/Projects/secretgifter/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 96 - ((3 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
96
